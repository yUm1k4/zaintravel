...
@section('content')
    ...
    <main>
        ...
        <section class="section section-popular-content" id="popularContent">
            <div class="container">
            ...
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/user_pic-1.png" alt="User" class="mb-4 rounded-circle">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/user_pic-2.png" alt="User" class="mb-4 rounded-circle">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/user_pic-3.png" alt="User" class="mb-4 rounded-circle">
