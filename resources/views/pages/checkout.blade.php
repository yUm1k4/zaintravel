                    ...
                    <div class="card card-details">
                            ...
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    @forelse ($item->details as $detail)
                                        <tr>
                                            <td><img src="https://ui-avatars.com/api/?name={{ $detail->username }}" class="rounded-circle" height="60" alt=""></td>
                        ...
                        <div class="member mt-3">
                            ...
                            <form action="{{ route('checkout-create', $item->id) }}" method="POST" class="form-inline">
                                ...
                                <input type="text" required name="nationality" class="form-control mb-2 mr-sm-2" style="width: 50px;" id="nationality" placeholder="Nationality">
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right text-total">
                                    <span class="text-blue">$ {{ $item->transaction_total }},</span><span class="text-orange">{{ mt_rand(9, 99) }}</span>
                                </td>
                            </tr>
                        </table>
                        <hr>
